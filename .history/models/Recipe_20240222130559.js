...
for (let ingredient of recipe.ingredients) {
  // Найти продукт в базе данных по ID
  let product = await ProductModel.findById(ingredient.product);

  if (!product) continue; // Продолжить, если продукт не найден

  // Рассчитать вклад продукта в питательные значения рецепта
  let amountFactor = ingredient.amount / 100; // Преобразование к 100 граммам, если необходимо
